  ...
  return <footer className="bg-muted/30 border-t border-border/50">
    <div className="container mx-auto px-4 py-8 md:py-12">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-2 mb-3 md:mb-4">
              ...
              <div>
                ...
                <p className="text-xs md:text-sm text-muted-foreground">Mitra Penerbit Buku di Indonesia</p>
              </div>
            </div>
        ...
        <div className="border-t border-border/50 pt-6 md:pt-8 text-center text-xs md:text-sm text-muted-foreground">
          <p>&copy; {currentYear} KBM Kreator Yogyakarta. All rights reserved.</p>
